...
func (tag *Tag) IsKeyFrame() bool {
	return tag.mediat.frameType == core.FRAME_KEY
}

func (tag *Tag) IsSeq() bool {
	return tag.mediat.frameType == core.FRAME_KEY &&
		tag.mediat.avcPacketType == core.AVC_SEQHDR
}
...
func (tag *Tag) parseVideoHeader(b []byte) (n int, err error) {
	...
	n++
	if tag.mediat.frameType == core.FRAME_INTER || tag.mediat.frameType == core.FRAME_KEY {
