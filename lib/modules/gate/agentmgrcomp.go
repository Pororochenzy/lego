...
import (
	...
	"github.com/Pororochenzy/lego/utils/container"
)
...
func (this *AgentMgrComp) SendMsg(aId string, msg *[]byte) (result int, err string) {
...
func (this *AgentMgrComp) SendMsgByGroup(aIds []string, msg *[]byte) (result []string, err string) {
...
func (this *AgentMgrComp) SendMsgByBroadcast(msg *[]byte) (result int, err string) {
	for _, v := range this.Agents.Items() {
