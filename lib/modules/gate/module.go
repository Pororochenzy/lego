...
// 发送代理消息
func (this *Gate) SendMsg(sId string, msg *[]byte) (result int, err string) {
	return this.AgentMgrComp.SendMsg(sId, msg)
}

// 群发代理消息
func (this *Gate) SendMsgByGroup(aIds []string, msg *[]byte) (result []string, err string) {
	return this.AgentMgrComp.SendMsgByGroup(aIds, msg)
}

// 广播代理消息
func (this *Gate) SendMsgByBroadcast(msg *[]byte) (result int, err string) {
